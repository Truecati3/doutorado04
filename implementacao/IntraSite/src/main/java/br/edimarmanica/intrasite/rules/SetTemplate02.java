...
public class SetTemplate02 {
    ...
    public SetTemplate02(Site site) {
        this.site = site;
    }
    ...
    private void processCSV() {
        ...
        try (Reader in = new FileReader(Paths.PARTIAL_CSV_PATH + "/" + site.getPath() + "/" + NODE_FILE_NAME)) {
            ...
            Logger.getLogger(SetTemplate02.class.getName()).log(Level.SEVERE, null, ex);
    ...
    /*    Domain domain = br.edimarmanica.dataset.swde.Domain.JOB;
        ...
        SetTemplate02 st = new SetTemplate02(br.edimarmanica.dataset.swde.job.Site.MONSTER); //finalizei o JOBTARGET
        st.execute();
    }
}
