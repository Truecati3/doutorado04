...
public class CypherNotationTest extends TestCase {
    ...
    public void testGetNotation() {
        ...
        String expResult = "MATCH (a2)<--(a1)<--(a0)<--(b)-->(c0)-->(c1)-->(c2) "
                + "\nWHERE a2.VALUE='Author:' AND a2.PATH='/HTML/BODY/FONT/TABLE/TR/TD/TABLE/TR/TD/TABLE/TR/TD/TABLE/TR/TD/p/text()' "
         ...
         * ***************** Teste 02 ***************
         */
        uniquePathValue = "/HTML[1]/BODY[1]/FONT[1]/TABLE[2]/TR[2]/TD[2]/TABLE[2]/TR[1]/TD[1]/TABLE[1]/TR[1]/TD[1]/TABLE[1]/TR[1]/TD[3]/A[1]/text()[1]";
